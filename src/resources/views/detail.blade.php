...
<div class="fruit-content">
    <form action="/products/{productId}/update" method="post" class="edit-form">
        ...
        <div class="fruit-items">
            ...
            <textarea name="description" value="{{ old('description') }}" cols="100" rows="10" class="fruit-items__textarea" placeholder="商品の説明を入力"></textarea>
            <div class="alert">
                <p class="alert--danger">
                    @error('description')
                    {{ $message }}
        ...
        <div class="button">
            ...
            <input type="submit" value="変更を保存" class="edit-button" name="send">

            <form action="/products" method="post" class="delete">
                @method('delete')
                @csrf
